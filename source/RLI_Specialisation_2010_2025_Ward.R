...
ggsave("./Figs/Summary/RLI/RLI_EuropeanButterflies2010_2025_HostPlantSpecialisation.jpg",
			 width = 6,
			 height = 4,
			 dpi = 150)
...
ggsave("./Figs/Summary/diffRLI/diffRLI_EuropeanButterflies2010_2025_HostPlantSpecialisation.jpg",
			 width = 12,
			 height = 5,
			 dpi = 150)
